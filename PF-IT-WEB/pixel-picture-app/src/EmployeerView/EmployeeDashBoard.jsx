...
const EmployeeDashboard = () => {
  ...
  const columns = ['ID', 'userName', 'Correo']
  const userData = [
  ...
  return (
    <div>
      ...
      <div className='container m-auto'>
        <h2 className='text-center text-3xl font-bold my-4'>Encargos asignados</h2>
        <Table columns={columns} data={userData} pageSize={10}/>
      </div>
      <div className='container m-auto'>
        <h2 className='text-center text-3xl font-bold mb-4'>Encargos disponibles</h2>
        <Table columns={columns} data={userData} pageSize={10}/>
      </div>
    </div>
  );
